...
class BaseConfig:
    ...
    SERVICE_BUS_CONNECTION_STRING ='Endpoint=sb://notificationqueue.servicebus.windows.net/;SharedAccessKeyName=techconf;SharedAccessKey=FYUAVW9IeybjVxA+X0AjEnSypnN2oDWdJH5MJwfsSz4=;EntityPath=notificationqueue' #TODO: Update value
